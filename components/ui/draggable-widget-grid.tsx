 ...
 * Componente de terceiros copiado como veio: ele lê refs durante o render de
 * propósito (ordem fixa do DOM e valores "mais recentes" pros handlers de
 * arraste). As regras do React Compiler reprovam esse padrão. */
...
const Widget = memo(function Widget({
	...
	return (
		<motion.div
			...
			transition={SPRING}
			className={`relative min-w-0 rounded-[var(--widget-radius)] outline-hidden focus-visible:ring-2 focus-visible:ring-ring [&_a]:[-webkit-user-drag:none] [&_img]:[-webkit-user-drag:none] ${
				editable
